...
$global:_ompExecutable = 'C:/Users/lishu/AppData/Local/Programs/oh-my-posh/bin/oh-my-posh.exe'
...
New-Module -Name "oh-my-posh-core" -ScriptBlock {
    ...
    if ('E:\lishu\Documents\PowerShell\simple.omp.json' -and (Test-Path -LiteralPath 'E:\lishu\Documents\PowerShell\simple.omp.json')) {
        $env:POSH_THEME = (Resolve-Path -Path 'E:\lishu\Documents\PowerShell\simple.omp.json').ProviderPath
    }
